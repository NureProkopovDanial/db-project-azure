...
//Auth Db Connection
var url = config.cosmosDB.connectionString; // Берем строку из конфига
var authDBName = config.cosmosDB.authDBName || "AuthDB"; // Имя БД, если оно отличается

mongoose.connect(url, {
    dbName: authDBName, // Указываем имя БД
    useNewUrlParser: true,
    useUnifiedTopology: true // Добавляем этот флаг
});
